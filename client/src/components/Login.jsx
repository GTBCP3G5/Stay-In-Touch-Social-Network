      ...
      <div className="w-full max-w-md m-auto bg-white rounded-lg border border-primaryBorder shadow-default py-10 px-1">
        <div className="text-primary m-6">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center mt-3 justify-center">
              <button type="submit" style={{ cursor: "pointer" }} className={"bg-blue-700 hover:bg-blue-500 py-2 px-4 text-md text-white rounded border border-blue focus:outline-none focus:border-black"}>Login</button>
            </div>
          </form>
          ...
          {error && (
            <div className="text-xl font-bold text-red-700 uppercase mt-6 mb-2">{'Incorrect username or password'}</div>
          )}
